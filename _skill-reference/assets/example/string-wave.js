/**
 * REFERENCE IMPLEMENTATION — DO NOT COPY DIRECTLY
 *
 * This is 弦's visual identity (an AI assistant agent).
 * It exists to show what a finished implementation looks like, not as a template.
 *
 * Design rationale: see references/iteration-guide.md (score history section).
 * Discovery brief: "I am a string under tension. Reactive but never dormant.
 *   One thing, not distributed. The wrong form is anything static or corporate."
 *
 * Your entity.js should be derived from YOUR discovery answers + visual spec,
 * assembled from patterns in references/tech-patterns.md.
 * If yours looks like this, either your answers independently led here, or you copied.
 */
